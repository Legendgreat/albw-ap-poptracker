...
| ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| Gulley             | ![Gulley](images/prizes/sage_gulley.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/prizes/sage_gulley.png)                     |                                                                                              |
| Oren               | ![Oren](images/prizes/sage_oren.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/prizes/sage_oren.png)                           | - Queen Oren                                                                                 |
| Seres              | ![Seres](images/prizes/sage_seres.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/prizes/sage_seres.png)                        |                                                                                              |
| Osfala             | ![Osfala](images/prizes/sage_osfala.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/prizes/sage_osfala.png)                     | - Ravio's Sand Rod Slot Item                                                                 |
| Impa               | ![Impa](images/prizes/sage_impa.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/prizes/sage_impa.png)                           | - Hyrule Castle Throne Room                                                                  |
| Irene              | ![Irene](images/prizes/sage_irene.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/prizes/sage_irene.png)                        | - Irene                                                                                      |
| Rosso              | ![Rosso](images/prizes/sage_rosso.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/prizes/sage_rosso.png)                        | - Unlocks Rosso's House's front door <br>- Rosso <br>- Rosso Rocks <br>- Rosso's House Crack |
| Pendant of Power   | ![Pendant of Power](images/prizes/pendant_power.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/prizes/pendant_power.png)       |                                                                                              |
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![Gulley](images/prizes/sage_gulley.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/prizes/sage_gulley.png) | ![Oren](images/prizes/sage_oren.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/prizes/sage_oren.png) | ![Seres](images/prizes/sage_seres.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/prizes/sage_seres.png) | ![Osfala](images/prizes/sage_osfala.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/prizes/sage_osfala.png) | ![Impa](images/prizes/sage_impa.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/prizes/sage_impa.png) | ![Irene](images/prizes/sage_irene.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/prizes/sage_irene.png) | ![Rosso](images/prizes/sage_rosso.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/prizes/sage_rosso.png) |

You can configure how many must be collected with the following settings:

| Setting                                                                                                                                                                                                                 | Range | Default | Specifies Requirement For                                                          |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- | ------- | ---------------------------------------------------------------------------------- |
| ![Lorule Castle Requirement](images/prizes/sage_zelda.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/prizes/sage_zelda.png) | 0-7   | 7       | - Entering Lorule Castle's Front Door <br>- Spawning Final Boss in the Throne Room |
...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | ---------------------------------------------------------------------- |
| ![Pendant of Wisdom](images/prizes/pendant_wisdom.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/prizes/pendant_wisdom.png)![Pendant of Power](images/prizes/pendant_power.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/prizes/pendant_power.png)![Pendant of Courage](images/prizes/pendant_courage.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/prizes/pendant_courage.png) | Normal  | Require all Pendants of Virtue.                                        |
| ![Pendant of Wisdom](images/prizes/pendant_wisdom.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/prizes/pendant_wisdom.png)![Pendant of Power](images/prizes/pendant_power.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/prizes/pendant_power.png)                                                                                                                                                                                                                           | Vanilla | As in the vanilla game, only require the Pendants of Power and Wisdom. |
...
| Mode                                                                                                                                                                                                                     | Description                                                                                                                                                                         |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![Normal Logic](images/settings/Normal.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/settings/Normal.png)                   | Standard gameplay, no tricky item use or glitches.                                                                                                                                  |
| ![Hard Logic](images/settings/Hard.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/settings/Hard.png)                         | Adds tricks that aren't technically glitches.                                                                                                                                       |
| ![Glitched Logic](images/settings/Glitched.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/settings/Glitched.png)             | Includes the above plus "basic", easy-to-learn glitches.                                                                                                                            |
| ![Adv Glitched Logic](images/settings/Adv_Glitched.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/settings/Adv_Glitched.png) | Includes the above plus "advanced" glitches that may be a challenge to master.                                                                                                      |
| ![Hell Logic](images/settings/Hell.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/settings/Hell.png)                         | Includes every known RTA-viable glitch, including the insane ones. Note that the Bee Badge is omitted from the item pool in this mode, to preserve the infamous Bee Boosting trick. |
...
![Swordless](images/items/fsword.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/items/fsword.png) ![Swordless](images/items/x_small.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/items/x_small.png)
...
![Minigames](images/settings/minigames.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/settings/minigames.png)
...
![Bee Boost Glitches](images/display/bottle_bee.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/display/bottle_bee.png)
...
![Maiamai Map](images/display/maiamai_map.png)](https://github.com/Legendgreat/albw-ap-poptracker/blob/master/images/display/maiamai_map.png)
